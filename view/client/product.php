                                ...
                                <div class="product_layout_content bg-white position-relative">
                                    <div class="product_image_wrap">
                                        <a class="product_image d-flex justify-content-center align-items-center"
                                            href="index.php?page=chitiet_sanpham&id=<?= $product['product_id'] ?>&iddm=<?= $product['cate_id'] ?>" target="_blank">
                                        ...
                                        <ul class="product_action_btns ul_li_block d-flex">
                                            <li>
                                                <a class="tooltips" data-placement="top" title="Search Product" href="#!"><i
                                    ...
                                    <div class="product_content">
                                        <h3 class="product_title">
                                            <a href="shop-list.html" target="_blank"><?php echo $product['product_name'] ?></a>
                                        </h3>
                                        <div class="product_price">
                                            <span class="sale_price pe-1"><?php echo $product['price'] ?> VNĐ</span>
                                            <!-- <del>$65.00</del> -->
                                        </div>
                                    </div>
                                </div>
