<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from jthemes.net/themes/html/organic/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Nov 2023 14:56:31 GMT -->
...
<head>
    ...
    <link rel="stylesheet" href="./view/assets/css/slick-theme.css" />
                    ...
                    <div class="header_top d-flex align-items-center justify-content-between">
                        <div class="header_top_content d-flex pt-2">
                            <div class="mail_text_content d-flex">
                                ...
                                <p class="mail_text">Hue@webmail.com</p>
                            </div>
                            <div class="address_text_content d-flex">
                                <p class="mail_icon">
                                    <span><i class="fas fa-map-marker-alt text-white pe-2"></i></span>
                                </p>
                                <p class="address_text">15/A, Nest Tower,NYC</p>
                            </div>
                        </div>
                        <div class="header_top_socials pt-2">
                            <ul class="list-unstyled d-flex">
                                <li>
                                    <a href="#!"><i class="fab fa-facebook-f text-white pe-3"></i></a>
                                </li>
                                <li>
                                    <a href="#!"><i class="fab fa-twitter text-white pe-3"></i></a>
                                </li>
                                <li>
                                    <a href="#!"><i class="fab fa-instagram text-white pe-3"></i></a>
                                </li>
                                <li>
                ...
                <div class="container">
                    ...
                    <div class="webMenu d-none d-lg-block position-relative">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav main_menu_list m-auto after_navbar">
                                  ...
                                  background-image: url(./view/assets/images/sales/sale1.png);
                                ">
                                                            <div class="thumb_text">
                                                                <h2>
                                                                    <font>100%</font> Pure <br />
                                                                    Natural Vegetable
                                                                </h2>
                                                                <span>Fresh Vegetables Sale 30% Off</span>
                                                                <a href="#"><button type="button"
                                                                        class="btn custom_btn rounded-pill text-white mt-3">
                                                                        View More
                                                                    </button></a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="mega_item_area my-4 position-relative">
                                                            ...
                                                            <div class="mega_item_thumb2 position-absolute">
                                                                <img src="./view/assets/images/mega/mega2.png"
                                                                    alt="image_not_found" />
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="webmenu_bottom_shape_left position-absolute">
                            <img src="./view/assets/images/shapes/shape1.png" alt="image_not_found" />
                        </div>
                    </div>
                    <!-- mobile menubar start -->
                    <div class="mobileMenu d-block d-lg-none">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <a class="navbar-brand" href="index.html"><img src="./view/assets/images/logo/logo.png"
