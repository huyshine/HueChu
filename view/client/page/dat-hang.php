                ...
                <form action="#">
                    <div class="form_wrap">
                        ...
                        <div class="checkbox_item">
                            <label for="account_create_checkbox"><input id="account_create_checkbox" type="checkbox">
                        ...
                        <div class="checkbox_item mb_30">
                            <label for="ship_address_checkbox"><input id="ship_address_checkbox" type="checkbox"> Ship
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="cart_product">
                                                <div class="item_image">
                                                    <img src="./view/assets/images/cart/cart2.png"
                                                        alt="image_not_found">
                                                </div>
                                                <div class="item_content">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="cart_product">
                                                <div class="item_image">
                                                    <img src="./view/assets/images/cart/cart3.png"
                                                        alt="image_not_found">
                                                </div>
                                                <div class="item_content">
