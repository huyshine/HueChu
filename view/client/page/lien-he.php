                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contact_us_tetimonial d-flex flex-column" data-aos="fade-right" data-aos-duration="2000">
                            <span class="tetimonial_desc">Buy Natural, sustainable and chemicalfree products
                                from local sellers across the country.</span>
                            <a class="tetimonial_author text-uppercase mt-3" href="#!"><img
                                    src="./view/assets/images/shapes/shape23.png" alt="image_not_found"> Creative.
                                Modern. Smart.</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <p class="contact_top_desc" data-aos="fade-left" data-aos-duration="2000">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            Praesent molestie nec nisl eget scelerisque. Quisque placerat suscipit eros, eu
                            tincidunt tellus blandit vel. Donec pellentesque dapibus interdum. Mauris et
                            tellus congue, rutrum neque a, varius felis. Phasellus nibh diam, tincidunt nec
                            risus ut, auctor gravida metus.</p>
                        <a href="#!"><button type="button"
                                class="btn custom_btn load_more_1 rounded-pill px-3 px-sm-4 py-3 text-white text-uppercase">Read
                                About Us <i class="fas fa-long-arrow-alt-right"></i></button></a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="contact_us_info position-relative" data-aos="fade-up" data-aos-duration="2000">
    <div class="comment_area_wrap" style="background-image: url(./view/assets/images/backgrounds/bg15.png)">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 sec_space_small position-relative">
                    ...
                    <img class="contact_info_thumb_right position-absolute"
                        src="./view/assets/images/product/product36.png" alt="image_not_found">
                </div>
                <div class="col-lg-6">
    ...
    <img class="contact_info_thumb_left position-absolute" src="./view/assets/images/shapes/shape22.png"
        alt="image_not_found">
                ...
                <div class="col-md-6 col-lg-4 text-center">
                    <div class="address_sec_cont d-flex flex-column position-relative" data-aos="fade-right" data-aos-duration="2000">
                        ...
                        <p class="address_desc">We are a strong community of 100,000+ customers and 600+
                            sellers who aspire to be good</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 text-center">
                    <div class="address_sec_cont d-flex flex-column position-relative" data-aos="fade-up" data-aos-duration="2000">
                        ...
                        <p class="address_desc">855 Road Broklyn Street, 600 New York, USA</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 text-center">
                    <div class="address_sec_cont d-flex flex-column position-relative" data-aos="fade-left" data-aos-duration="2000">
                        ...
                        <p class="address_desc">222 555 999 needhelp@organi.com</p>
                    </div>
                </div>
            </div>
        </div>
